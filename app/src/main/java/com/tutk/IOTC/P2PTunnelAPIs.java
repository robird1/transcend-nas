...
public class P2PTunnelAPIs {
	...
	* can't be connected anymore until anyone session release. */
	...
	public native int  P2PTunnelAgent_Connect_Stop(String UID);
	...
	public native int P2PTunnelAgent_StopPortMapping_byIndexArray(int[] indexArray, int indexNum);
	...
	public void ChangeIP2PTunnelCallback(IP2PTunnelCallback obj){
		mSelf = obj;
	}
