...
public class Server {
	...
	*/
	...
	public boolean isServiceAvail(Service service) { return service.isAvailable; }
	public void enableServiceAvail(Service service, boolean isAvailable) { service.isAvailable = isAvailable; }
	public boolean isBackUPServiceAvail() { return isBackUPServiceAvailable; }
	public String getLastBackupTime(){ return lastBackupTime; }
	public void setLastBackupTime(String time){ lastBackupTime = time; }
	...
	private boolean doGetServerInfo(){
		boolean isSuccess = false;
		InputStream inputStream = null;
