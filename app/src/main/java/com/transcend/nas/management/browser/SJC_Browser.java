...
public class SJC_Browser extends Browser implements Browser.StateMonitor {
    static final String TAG = SJC_Browser.class.getSimpleName();
    private SJC_FileManageActivity mActivity;
...
//        updateViewReference();
    ...
    private void updateViewReference() {
        BrowserFragment fragment = getCurrentFragment();
