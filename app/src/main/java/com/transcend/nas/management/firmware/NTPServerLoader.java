...
public class NTPServerLoader extends AsyncTaskLoader<Boolean> {
    private static final String TAG = NTPServerLoader.class.getSimpleName();
    ...
    public Boolean loadInBackground() {
        ...
        try {
            ...
            String server = doParse(message.string());
        ...
        try {
            ...
            do {
                ...
                if (eventType == XmlPullParser.START_TAG) {
                    if (tagName.equals("myntp")) {
                        parser.next();
                        mNTPServer = parser.getText();
                        break;
                    }
                }
