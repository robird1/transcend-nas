...
public class TwonkyIndexLoader extends TwonkyGeneralPostLoader {
    private static final String TAG = TwonkyIndexLoader.class.getSimpleName();
    private String mPath;
    private String mOperation;
    private String mApiArgs;
    public static final HashMap<String, String> mMonthMap = new HashMap();
    public static final HashMap<String, String> mMonthMap2 = new HashMap();
    ...
    public TwonkyIndexLoader(Context context, Bundle args) {
        super(context, args);
...
//        Log.d(TAG, "[Enter] setFileInfo");
        if ("get_photo_album".equals(mOperation) || "get_video_album".equals(mOperation)) {
            ...
            info.twonkyIndexCount = arrJson.getJSONObject(i).getInt("count");
//            Log.d(TAG, "info.twonkyIndexCount: "+ info.twonkyIndexCount);
        }
